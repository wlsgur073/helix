...
function registryPath(home) {
  return join3(home, "projects.json");
}
function ownerFile(projectRoot) {
  return join3(projectRoot, ".helix", ".owner");
}
