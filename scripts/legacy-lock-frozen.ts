// FROZEN verbatim copy of src/memory/lock.ts as of feat/helix-v1 @ 22bc4bd (2026-07-14), BEFORE the
// lock-durability redesign. This IS the algorithm old installed bundles run. Used by interop tests
// to drive real old-vs-new process pairs. Do not modernize; do not lint-fix.
